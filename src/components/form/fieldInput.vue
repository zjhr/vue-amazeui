<template>
    <input v-if="type==='number'"
        ...
        @focus="focusHandler"
        @blur="blur"/>
        <select v-else-if="type==='select' || options || $slots.default"
        :name="name"
        class="field"
