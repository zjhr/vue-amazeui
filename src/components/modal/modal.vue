<template>
    <div rel="modal">
            ...
            <div v-else-if="role==='actions'">
                <actions v-show="isOpen" :menus="menus" 
                :noShowCancel="noShowCancel" :cancelText="cancelText"
                @actionsClick="actionsClickFun" @actionsCancel="modalCloseFun"></actions>
            </div>
                    ...
                    <div v-show="isOpen" class="modal-inner">
                        <div class="modal-dialog">
                            <div class="modal-header">
                                ...
                                <span v-if="role==='' && !closeBtn" class="icon icon-close modal-icon"
                                    @click="modalCloseFun"></span>
                            </div>
        ...
        <transition>
            <div v-show="isOpen" class="modal-backdrop active" @click="!!closeFromBack && modalCloseFun()" :style="{height:modalHeight+'px'}"></div>
        </transition>
    </div>
</template>
