    ...
    <vueview>
        ...
        <div class="sk-demos">
            ...
            <group noPadded header="含描述的文字列表">
                <list>
                    <list-item title="女爵" after="2017.02"
                    subTitle="发行公司：环球唱片"
                    desc="她坦白了我们所虚伪的 她单纯了我们所复杂的
                        五年以来…
                        5年的等待，是个漫长也是耗损的过程。
                        ...
                        是我们唯一相信且期待杨乃文的理由。"
                    href="http://music.163.com/#/album?id=31308"></list-item>
                    ...
                    <list-item title="Silence" after="2017.02"
                        subTitle="发行公司：魔岩唱片"
            ...
            <group noPadded header="图文列表">
                <list>
                    ...
                    <list-item title="第一张精选" after="2017.02"
                        subTitle="发行公司：滚石唱片" href="http://music.163.com/#/album?id=31312">
                        <img slot="img" src="http://lorempixel.com/160/160/people/" width="48" alt="">
                    </list-item>
                    <list-item title="Silence" after="2017.02"
                        subTitle="发行公司：魔岩唱片" href="http://music.163.com/#/album?id=31319">
                        <img slot="img" src="http://lorempixel.com/160/160/people/" width="48" alt="">
                    </list-item>
                </list>
            </group>
            ...
            <list>
                ...
                <list-item title="第一张精选" after="2017.02"
                    subTitle="发行公司：滚石唱片"
                    desc="出道六年来只出过三张专辑的杨乃文，第一次集合三张专辑的精华构成了这张充满个性的精选辑。专辑收录尚未发片前首先曝光，原始浓烈的杨乃文独唱曲[爱上你只是我的错]、曾让无数人伤感落泪的《我给的爱》、悲情经典《silence》、杨乃文96年在魔岩校园live演唱会上敏感热烈的创作《fear》、充满古典优雅气质的电影[第凡内早餐]的主题曲《monn river》等好歌。通过尝试各种新鲜形象，搭配MV营造的氛围，总是给人耳目一新的新感觉。"
