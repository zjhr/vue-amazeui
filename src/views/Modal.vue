<template>
    <vueview>
        ...
        <group header="Confirm">
            ...
            <modal role="confirm" title="vue-amazeui" :isOpen="open2"
             @Close="modalOutFun('open2')" @Confirm="modalConfirm('open2')">这一个 Confirm 窗口。</modal>
        </group>
        <group header="Prompt">
            <div>
                <vue-button blue @buttonClick="modalOpFun('open3')">Prompt Modal</vue-button>
            </div>
            <modal role="confirm" title="vue-amazeui" :isOpen="open3"
             @Close="modalOutFun('open3')" @Confirm="modalConfirm('open3',msg)">
                输入你的 IQ 卡密码：
        ...
        <group header="多个输入框">
            ...
            <modal role="confirm" title="Login" :isOpen="open4"
             @Close="modalOutFun('open4')">
                <form-group set>
